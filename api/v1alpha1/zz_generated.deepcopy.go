...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaveSelect) DeepCopyInto(out *WaveSelect) {
	*out = *in
	if in.Names != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaveSelect.
func (in *WaveSelect) DeepCopy() *WaveSelect {
	if in == nil {
		return nil
	}
	out := new(WaveSelect)
