...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromiseAPI) DeepCopyInto(out *PromiseAPI) {
	*out = *in
	if in.Template != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromiseAPI.
func (in *PromiseAPI) DeepCopy() *PromiseAPI {
	if in == nil {
		return nil
	}
	out := new(PromiseAPI)
