...
// +kubebuilder:rbac:groups=platform.kratix.io.kratix.io,resources=pipelinetriggers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.kratix.io.kratix.io,resources=pipelinetriggers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=platform.kratix.io.kratix.io,resources=pipelinetriggers/finalizers,verbs=update
