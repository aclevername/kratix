oras push demo.goharbor.io/syntassodev/kafka-worker-cluster-resources:latest --artifact-type application/vnd.docker.image.rootfs.diff.tar.gzip resources.tar.gz
